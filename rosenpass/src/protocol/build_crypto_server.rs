...
impl Keypair {
    ...
    /// Creates a new (securely-)random key pair. The mechanism is described in [rosenpass_secret_memory::Secret][rosenpass_secret_memory::Secret].
    ///
...
/// Builder for setting up a [CryptoServer][crate::protocol::CryptoServer] (with deferred initialization).
///
